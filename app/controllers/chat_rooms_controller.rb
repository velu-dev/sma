class ChatRoomsController < ApplicationController
  ...
  def create
    ...
    @chat_room.first_user_id = current_user.id
    @chat_room.user_id = current_user.id
    respond_to do |format|
      if @chat_room.save
        format.html { redirect_to messages_path, notice: "Chat room was successfully created." }
  ...
  def chat_room_params
    params.require(:chat_room).permit(:room_name, :user_id, :first_user_id, :second_user_id, :is_group, :is_private)
  end
end
